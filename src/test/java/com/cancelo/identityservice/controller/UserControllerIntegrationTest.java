...
public class UserControllerIntegrationTest {
    ...
    static void configureDatasource(DynamicPropertyRegistry registry) {
        ...
        registry.add("spring.jpa.hibernate", () -> "update");
    }
    ...
    void createUser_validRequest_success() throws Exception {
        ...
        var response = mockMvc.perform(MockMvcRequestBuilders.post("/users")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("result.username").value("lamletung"))
                .andExpect(MockMvcResultMatchers.jsonPath("result.firstName").value("le"))
                .andExpect(MockMvcResultMatchers.jsonPath("result.lastName").value("lam"));
